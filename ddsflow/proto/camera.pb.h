...
inline bool CamDirect_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CamDirect* value) {
...
inline bool CamFov_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CamFov* value) {
...
inline bool ProjectionModel_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ProjectionModel* value) {
